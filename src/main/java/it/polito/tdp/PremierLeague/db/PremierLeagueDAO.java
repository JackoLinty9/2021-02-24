...
public class PremierLeagueDAO {
	...
	public List<Match> listAllMatches(){
		String sql = "SELECT m.MatchID, m.TeamHomeID, m.TeamAwayID, m.teamHomeFormation, m.teamAwayFormation, m.resultOfTeamHome, m.date, t1.Name, t2.Name   "
				...
				+ "WHERE m.TeamHomeID = t1.TeamID AND m.TeamAwayID = t2.TeamID ORDER BY m.MatchID ASC";
	...
	public List<Player> listAllVerteces(Match m, Map<Integer,Player>idMap){
		String sql = "SELECT DISTINCT actions.PlayerID, players.Name "+
	...
	public List<Arco> listAllEdge(Match m, Map<Integer,Player>idMap){
